    ...
    <div class="user-wrapper">
        <div class="login-wrapper">
            ...
            <form  method="post" >
                <label>
                    <p>Email</p>
                    <input type="text" name="loginEmail" id="">
                </label>
                <label>
                    <p>Password</p>
                ...
                <p class="login-alternative">Don’t have an account? <a href="register.php">Create an account</a></p>
            </form>
            <?php

                if((isset($_POST['loginSubmit']))) {

                    $query = "SELECT * FROM `userstb` WHERE Email='".$_POST['loginEmail']."' AND Password='".$_POST['loginPass']."'";
