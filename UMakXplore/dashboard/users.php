        ...
        <div class="summary-container">
          <div class="summary">
            <img src="../media/icons/totalUsersIcon.png" alt="">
            <h1>9432</h1>
            <p>Total Users</p>
          </div>
          <div class="summary">
        ...
        <div class="users-table-wrapper">
          <table>
            ...
            ?>
              ...
              <tr>
               <?php $masked_password = str_repeat("*", strlen($password));?>
                <td><?php echo $id; ?></td>
                <td><?php echo $name; ?></td>
                <td><?php echo $email; ?></td>
                <td><?php echo $masked_password; ?></td>
                <td>
                  <div class="action-container">
                    <a href="../dashboard/?menu=users&userId=user" class="user-action-edit">
                    ...
                    <a href="../dashboard/?menu=users&userId=user" class="user-action-delete">
            ...
            <!-- <?php
                  $menu = isset($_GET['menu']) ? $_GET['menu'] : ''; // get the value of the "menu" parameter from the URL
                  $user_id = isset($_GET['userId']) ? $_GET['userId'] : ''; // get the value of the "userId" parameter from the URL

                  if ($menu == 'users' && $user_id == 'user') {
                    echo 'User menu';
