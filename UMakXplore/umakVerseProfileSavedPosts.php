            ...
            <body class="bg-o1">
                <div class="box-b2" style="min-height: 100vh; margin: 100px auto 0 auto;">
                    ...
                    <div class="flex justify-content-between w-100" style="margin: 20px 0;">
                        <div class="bg-white" style="width: 49%;text-align: center;border-radius: 20px; padding: 10px 0;">POSTS</div>
                        <div class="bg-white" style="width: 49%;text-align: center;border-radius: 20px; padding: 10px 0;">SAVED</div>
                    </div>
                                    ...
                                    <div class="" style="width: 92%;">
                                        ...
                                        <div class="w-100 flex justify-content-between" style="margin-top: 10px;">
                                            <div class="w-100 flex justify-content-between" style="margin-top: 20px;">
                                                <a href="umakVerseNF.php?type=Article&id=<?= $postGet['PostID']?>&like=<?= $rowLike?>" class="bg-o1 justify-content-center flex align-items-center" style="border-radius: 10px; width: 24%; padding: 10px 0; cursor: pointer;text-decoration: none; color: black">
